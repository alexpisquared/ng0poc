...
namespace MonitorReaderEvents
{
    public class Program
    {
        ...
        public static void Main() => Main_NEW();

        public static void Main_Org()
        {
        ...
        static bool ExitRequested(ConsoleKeyInfo key)
        {
            return key.Modifiers == ConsoleModifiers.Control
                   && key.Key == ConsoleKey.Q;
        }

        public static void Main_NEW()
        {
            try
            {
                Console.WriteLine("  This program will monitor all SmartCard readers and display all status changes.\n");
                ...
                // Retrieve the names of all installed readers.
                var readerNames = GetReaderNames(); if (NoReaderFound(readerNames)) { Console.WriteLine("There are currently no readers installed."); Console.ReadKey(); return; }
